...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'restaurant.update': { roles: ['owner', 'manager'], key: 'restaurant-profile-updated', tenantPath: [], userPath: [] },
  'restaurant.delete': { roles: ['owner'], key: 'restaurant-profile-deleted', tenantPath: [], userPath: [] },
  'manager.delete': {
    roles: ['owner', 'manager'],
    key: 'manager-removed',
    tenantPath: ['restaurant', 'manager'],
    userPath: [],
  },
};

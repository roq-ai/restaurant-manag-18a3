  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the Full Potential of Your Business with Restaurant Manager - Your Ultimate SaaS Solution for Efficient Restaurant Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the Full Potential of Your Business with Restaurant Manager - Your Ultimate SaaS Solution for Efficient Restaurant Management.`}
            </Text>
            <Box
